...
var EProxyEvent = /* @__PURE__ */ ((EProxyEvent2) => {
  EProxyEvent2["PROP_SET"] = "PROP_SET";
  EProxyEvent2["PROP_DELETE"] = "PROP_DELETE";
  EProxyEvent2["UPDATE"] = "UPDATE";
  return EProxyEvent2;
})(EProxyEvent || {});
...
var createNestedSignals = (item) => {
  ...
  if (typeof an === "object" && isPlainObject2(an)) {
    return signal(
      Object.assign(
        {},
...
var unwrapNestedSignals = (item, options = {}) => {
  ...
  const unwrap = (item2) => {
    ...
    if (typeof item2 === "object" && isPlainObject2(item2)) {
